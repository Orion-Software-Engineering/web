...
export default function Event(uploadlength) {
  ...
  const stepSwitch = (st) => {
    switch (st) {
      ...
      case 1:
        return (
          <EventForm1 setExpand={setExpand} step={step} updateStep={setStep} />
        );

      case 2:
        return (
          <EventForm2 setExpand={setExpand} step={step} updateStep={setStep} />
        );

      case 3:
        return (
          <EventForm3 setExpand={setExpand} step={step} updateStep={setStep} />
        );

      case 4:
        return (
          <EventForm4 setExpand={setExpand} step={step} updateStep={setStep} />
        );
      ...
      <div className="h-screen bg-opacity-90 bg-[#F6F6F6]">
        ...
        <div className="flex justify-center items-center mt-8     ">
          <div
            className={
              step
                ? "bg-[url('../public/WhatsappB.png')] h-[400px] rounded-3xl  border-red-600 flex flex-col"
          ...
          {step ? (
            <div
              className={
                "w-[400px] h-[400px] flex flex-col gap-y-2 justify-center items-center rounded-3xl " +
                imgColors[step - 1] +
                (uploadlength ? "" : "")
              }
            >
