    ...
    return (
        <div className='h-[650px] flex border-red-600'>
            <div className='w-[600px] h-[400px] mt-[100px] ml-[100px]  border-red-600'>
                ...
                <div className='h-[200px] ml-[90px] w-[400px] font-semibold text-xl mt-[40px] text-[#0C7354] font-nunito text-center border-gray-600'>
            ...
            <div className='w-[690px] h-[550px] mt-[40px] ml-[60px] border border-red-600'>
                <Image src="/../public/Mountainguys.png" width='690px' height='550px' alt="Mountainguys" />
            </div>
        </div>
    )
}
