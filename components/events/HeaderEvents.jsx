  ...
  return (
    <div>
      {localStorage.getItem("user-info") ? (
        <>
          <div className="flex fixed top-0 z-50 justify-between items-center h-16 max-2-[1024] mx-auto px-4 text-black bg-[#F6F6F6] w-screen">
            <div className="flex">
              <Image
                src={Logo}
                alt="Logo_Image"
                ...
                height={"70px"}
              />
              <h1 className="pt-1 pl-1 w-full text-4xl font-bold text-blavk font-Nunito">
                <Link href={"/"}>Meet</Link>
              </h1>
            </div>
