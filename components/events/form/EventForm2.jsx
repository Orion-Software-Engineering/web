      ...
      <div className="flex flex-col h-[400px] justify-center items-center  border-blue-600 w-[400px] rounded-l-3xl ">
        <form ref={formRef} handleSubmit={handleSubmit} className="flex flex-col mb-[30px]" >
          ...
          <div className='flex justify-between bg-black text-white rounded-md px-3 '>
            <div className="flex flex-col gap-y-1">Day
              <select id="day" name="hourtime" form="Dateform"
            ...
            <div className="flex flex-col gap-y-1">Month
              <select id="month" name="hourtime" form="Dateform"
            ...
            <div className="flex flex-col gap-y-1 text-center"> Year
              <select id="year" name="hourtime" form="Dateform" className='h-auto w-14 bg-black' >
                <option>2022</option>
                <option>2023</option>
                <option>2024</option>
                <option>2025</option>
          ...
          <div className="mt-[20px] border-blue-400">
            ...
            <div className='flex justify-between bg-black text-white rounded-md px-3 '>
              <div className="flex flex-col gap-y-1">Hour
                <select id="hour" name="hourtime" form="timeform"
                  // size={5} 
                  // onfocus='this.size=10;' onblur='this.size=1;' onchange='this.size=1; this.blur();'
                  className='h-auto w-12 bg-black ' >
                  {Array.from({ length: 12 }, (x, i) => (
                    <option>{i + 1 > 9 ? "" : "0"}{i + 1}</option>))
                  }
                </select>
              </div>
              <div className="flex flex-col gap-y-1">Minute
                <select id="hour" name="hourtime" form="timeform"
                  className='h-auto w-12 bg-black pb-2 ' >
              ...
              <div className="flex flex-col gap-y-1 pr-1 text-left">AM
