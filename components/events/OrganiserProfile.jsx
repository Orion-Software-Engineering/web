    ...
    <div className=" container mx-auto">
      <div className=" flex w-full h-full bg-blue-300 rounded-xl mx-auto shadow-lg overflow-hidden ">
        <div className="w-1/2 flex flex-col items-center justify-center mt-4 bg-no-repeat bg-cover bg-center">
          ...
          <div>
          <p className=" mt pt-0 text-white">Organiser
          </p>
          </div>
        </div>
        <div class="w-1/2 py-16 px-12">
            <h2 className="font-Nunito text-2xl text-white mb-4 flex flex-row ">My Events
                <p className="px-40 " >Create New Events</p>  </h2>
