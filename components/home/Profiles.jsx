  ...
  return (
    <div className="h-[500px] flex  border-gray-600 font-nunito">
      ...
      <div className="w-[325px] h-[400px] mt-[50px] ml-[150px] border-gray-600">
        ...
        <div className=" border-gray-600 mt-[30px]">
          <p>
            It was tough finding people around my age with the similar taste in
            movies and TV shows. Through Orion Meet, I found a movie buddy and
      ...
      <div className="w-[325px] h-[400px] mt-[50px] ml-[150px] border-gray-600">
        ...
        <div className=" border-gray-600 mt-[30px]">
          <p>
            I’m not the best with social interactions but I got off to a good
            start on this app. After chatting with my new friend on the app, I
            felt my social abilities improve.
          </p>
        </div>
      </div>
    </div>
