    ...
    <div className="py-20 bg-slate-300">
      <div className="container mx-auto px-6 md:px-12 lg:px-8">
        <div className="mb-12 space-y-4 text-center font-Nunito">
          ...
          <p className=" font-Nunito text-gray-600 lg:w-8/12 lg:mx-auto">
            Meet with US
          </p>
        </div>
        <div className="pt-14">
          <div className="border space-y-8 group text-center font-Nunito   ">
            ...
            <a
              href="https://github.com/maxotuteye"
              className="text-center w-max mx-auto block text-blue-500"
            >
              View bio
            </a>
          </div>
        ...
        <div className="pt-14">
          <div className=" py-20 grid gap-28 md:grid-cols-3">
            <div className="border-t-4 space-y-8 group text-cente font-Nunito">
              ...
              <a
                href="https://github.com/Z3ROD4RK"
                className="text-center w-max mx-auto block text-blue-500"
              >
                View bio
              </a>
            ...
            <div className="border-t-4 space-y-8 group text-center font-Nunito">
              ...
              <a
                href="https://github.com/McSam-py"
                className="text-center w-max mx-auto block text-blue-500"
              >
                View bio
              </a>
        ...
        <div className=" py-20 grid gap-28 md:grid-cols-3">
          <div className="border-t-4 space-y-8 group text-center font-Nunito">
            ...
            <a
              href="https://github.com/Dillys3567"
              className="text-center w-max mx-auto block text-blue-500"
            >
              View bio
            </a>
          ...
          <div className="border-t-4 space-y-8 group text-center font-Nunito">
            ...
            <a
              href="https://github.com/kwasimbnyarko"
              className="text-center w-max mx-auto block text-blue-500"
            >
              View bio
            </a>
          ...
          <div className="border-t-4 space-y-8 group text-center font-Nunito">
            ...
            <a
              href="https://github.com/frank-app"
              className="text-center w-max mx-auto block text-blue-500"
            >
              View bio
            </a>
